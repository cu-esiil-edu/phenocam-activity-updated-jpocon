...
```{r}
# Create a subset of only grassland sites 
AG_sites <- subset(sitelist_table, primary_veg_type == "AG")  
...
# Save map
ggsave(paste0(dir, '/Map.png'), height = 5, width = 10)
...
# Save plot
png(paste0(dir, '/Canopy_greenness_timeseries.png'), width = 1000, height = 500, units = "px")
...
# Save plot
png(paste0(dir, '/Seasonal_transitions.png'), width = 1000, height = 500, units = "px")
...
# Save plot
png(paste0(dir, '/Spring_onset.png'), width = 1000, height = 500, units = "px")
...
# Save plot
png(paste0(dir, '/Autumn_onset.png'), width = 1000, height = 500, units = "px")
...
```{r}
# Save plot
png(paste0(dir, '/Monthly_canopy_greenness.png'), width = 1000, height = 500, units = "px")
