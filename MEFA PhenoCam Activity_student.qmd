...
# Save site map
ggsave(paste0(dir, '/Site_map.png'), width=10, height=5)
...
```{r}
# Save plot
png(paste0(dir, '/Canopy_greenness_timeseries-lacclair.png'), height = 500, width = 1000, units = "px")
...
# Save plot
png(paste0(dir, '/GCC_transitions-lacclair.png'), height = 500, width = 1000, units = "px")
...
# Save plot
png(paste0(dir, '/Spring_onsets-lacclair.png'), height = 500, width = 1000, units = "px")
